      ...
      <div className="about-container container-1 ">
        <div className="about-content flex items-center lg:flex-row flex-col -mt-[10rem]">
          <div className="lg:mb-0 mb-[3rem]">
            <h1 className="lg:text-[4rem] text-[2rem] text-[#054738] tracking-[-1.6px] mb-[1.3rem]">
              For those that want a home that impresses.
            </h1>
            <Link
              href="/about"
              className="flex items-center gap-[1rem] lg:justify-start"
            >
              About us{" "}
        ...
        <div className="mt-[4rem]">
          <Image
            ...
            height={1000}
            quality={100}
            className="w-full lg:h-[600px] h-[350px] object-cover"
          />
        </div>
      </div>
    </section>
