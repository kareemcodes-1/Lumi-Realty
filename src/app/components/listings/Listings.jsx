    ...
    return (
        <section className="listings section">
             <div className="listings-container container-1 flex items-center lg:flex-row flex-col gap-[2rem]">
                       <Image src="/house.jpeg" alt="" className="w-[700px] h-[400px]" width={1000} height={1000} quality={100}/>

                  <div>
                       <Image src="/house-2.jpeg" alt="" className="w-[700px] h-[350px]" width={1000} height={1000} quality={100}/>
                       <div className="lg:flex items-center justify-between mt-[1rem]">
                           <div>
                           <p className="lg:w-[300px] w-full text-[#054738]">Providing extensive experience and deep understanding of luxury real estate.</p>
                           </div>
