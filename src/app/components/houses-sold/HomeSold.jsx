        ...
        <section className="homesold section">
            <div className="homesold-container container-1">
                 <div className="homesold-content flex items-center lg:flex-row flex-col gap-[4rem]">
                      ...
                      <div className="">
                          <h1 className="lg:text-[5rem] text-[3rem] text-[#054738]">A Realtor that delivers.</h1>
                      </div>
                 </div>

                 <div className="flex lg:items-center items-start lg:flex-row flex-col gap-[10rem]">
                 <div className="flex flex-col text-[#054738] lg:w-[40%] w-full">
                       <div>
                           <div className="flex items-center justify-between border-b border-[#054738]">
                               <h1 className="lg:text-[7rem] text-[5rem] text-[#054738]">375+</h1>
                       ...
                       <div>
                           <div className="flex items-center justify-between">
                               <h1 className="lg:text-[7rem] text-[5rem] text-[#054738]">85+</h1>
                   ...
                   <div  className="lg:w-[50%] w-full">
                       <Image src="/about-firm-1.jpg" className="w-full h-[35rem] object-cover" width={1000} height={1000} quality={100} />
                   </div>
                 </div>
            </div>
        </section>
