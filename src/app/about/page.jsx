      ...
      <section className="about section">
        <div className="mt-[10rem] mx-[1.5rem]">
          <div className="flex items-end justify-end flex-col-reverse gap-[1.5rem]">
            ...
            <div>
              <p className="text-[1.2rem] text-white flex lg:items-end items-start lg:justify-end justify-start lg:w-[400px] w-full">
                For over 20 years we've been helping potential buyers find the
      ...
      <div className="container-1">
        <div className="lg:grid lg:grid-cols-3 flex lg:flex-row flex-col lg:gap-[2rem] gap-[2rem] mt-[3rem] ">
          <div className="lg:w-[300px] w-full">
            ...
            have developed a deep understanding of the luxury real estate market
            and the needs of high-end clientele.
          </div>

          <div className="lg:w-[300px] w-full">
            We have a proven track record of successfully selling high-end
            properties at top prices and can provide our clients with
            unparalleled service and expertise throughout the buying or selling
            process.
          </div>
      ...
      <div className="container-1 mt-[5rem]">
        <div className="flex items-start lg:justify-end justify-start flex-col gap-[2rem]">
          <div className="border-b border-[#054738] flex lg:items-end lg:flex-row flex-col lg:ml-auto lg:w-[80%] w-full lg:justify-between pb-[2rem]">
            <h2 className="lg:text-[4rem] text-[2.5rem] text-[#054738] text-start flex items-start justify-start">
              Communication
            </h2>
            <p className="w-[300px]">
              Clear and frequent communication is essential for building trust
              and ensuring our clients are always informed and up-to-date
          ...
          <div className="border-b border-[#054738] flex lg:items-end lg:flex-row flex-col lg:ml-auto lg:w-[80%] w-full lg:justify-between pb-[2rem]">
            ...
            <p className="lg:w-[400px] w-full">
              ...
              developments in the luxury real estate market, allowing us to
              provide his clients with expert advice and guidance.
            </p>
          </div>
          ...
          <div className="border-b border-[#054738] flex lg:items-end lg:flex-row flex-col lg:ml-auto lg:w-[80%] w-full lg:justify-between pb-[2rem]">
            ...
            <p className="lg:w-[400px] w-full">
              Real estate transactions can be time-sensitive. We are always
              available to assist our clients, whether it’s answering questions,
              arranging property viewings, or negotiating.
            </p>
          </div>
          ...
          <div className="border-b border-[#054738] flex lg:items-end lg:flex-row flex-col lg:ml-auto lg:w-[80%] w-full lg:justify-between pb-[2rem]">
            ...
            <p className="lg:w-[400px] w-full">
              We provide personalized attention and tailored services to ensure
              our clients have a stress-free and enjoyable real estate
      ...
      <div className="container-1 mt-[5rem]">
        <div className="flex items-start flex-col">
          <div className="flex flex-col gap-[1rem] mb-[1rem]">
            <h2 className="lg:text-[4.5rem] text-[3rem] text-[#054738]">
              The numbers don't lie
            </h2>
            <p className="lg:w-[400px] w-full">
              For over 20 years we have been helping potential buyers find the
              home of their dreams.
            </p>
            <Link
              href="/contact"
              className="flex items-center gap-[1rem] lg:justify-center justify-start"
            >
              Reach out{" "}
        ...
        <div className="listings-container container-1 flex lg:items-center lg:flex-row flex-col gap-[2rem]">
          ...
          <div>
            ...
            <div className="lg:flex items-center justify-between mt-[1rem]">
              <p className="w-[300px] text-[#054738]">
